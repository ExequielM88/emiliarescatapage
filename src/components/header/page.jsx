'use client'
import Logo from '@/assets/headerFooterImg/LogoEmilia-new.png'
...
const Header = () => {
  ...
  const buttonHeader = {
    style:"flex  text-sm bg-colorText text-TextWhite rounded-xl py-2 px-3 hover:scale-110 hover:-translate-y-1 duration-300 md:text-lg",
    ref: "/donaciones",
    title:"Quiero donar"
  }
