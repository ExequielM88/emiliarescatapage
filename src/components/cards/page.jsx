  ...
  return (
    <div className="rounded w-full flex flex-col gap-6 items-center max-w-[500px] md:justify-evenly md:flex-row md:max-w-full ">
      {planMembresia.map((card) => (
        <div
          key={card.id}
          className="flex flex-col border-2 border-borderCardMembresia p-5 rounded-lg md:w-[30%] md:h-[450px] md:justify-between lg:min-h-[32rem] lg:h-auto"
        >
          <Image
          ...
          <Link href={`/membership/${card.membershipId}`}>
            <button className="w-full text-TextWhite bg-donationsButton rounded-lg py-2.5 shadow-slate-500 shadow-[0px_2px_4px_0px]">
              {card.btnText}
            </button>
          </Link>
        </div>
  ...
  return (
    <div className="rounded w-full flex flex-col gap-6 items-center max-w-[500px] md:justify-evenly md:flex-row md:max-w-full">
      {planFijo.map((card) => (
        <div
          key={card.id}
          className="flex flex-col border-2 p-5 rounded-lg md:w-[30%] md:h-[450px] md:justify-between lg:min-h-[32rem] lg:h-auto"
        >
          <Image
            className="w-full object-cover rounded-lg"
            src={card.image}
          ...
          <Link href={`/donaciones/membership/${card.membershipId}`}>
